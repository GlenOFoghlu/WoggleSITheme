...
//add_filter('nhp-opts-sections-Woggle', 'add_another_section');
...
//add_filter('nhp-opts-args-Woggle', 'change_framework_args');
...
$args['opt_name'] = 'Woggle';

//Custom menu icon
//$args['menu_icon'] = '';

//Custom menu title for options page - default is "Options"
$args['menu_title'] = __('Woggle Options', 'nhp-opts');

//Custom Page Title for options page - default is "Options"
$args['page_title'] = __('Woggle Options', 'nhp-opts');
...
$sections[] = array(
				'title' => __('Getting Started with Woggle ', 'nhp-opts'),
...
$sections[] = array(
				...
				'title' => __('Scout Group Info', 'nhp-opts'),
